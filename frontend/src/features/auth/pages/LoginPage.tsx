...
/**
 * Login page — full-screen centered card with glassmorphism.
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-x-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-wms-text tracking-tight">Welcome Back</h1>
          <p className="text-sm text-wms-secondary mt-2">
            Sign in to your Workspace Management System
          </p>
        </div>
